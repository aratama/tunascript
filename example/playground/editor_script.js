...
const tunaHighlightStyle = HighlightStyle.define([
  { tag: [t.keyword, t.controlKeyword, t.moduleKeyword], color: "#0b4ad1" },
  { tag: [t.typeName], color: "#8a2be2" },
  { tag: [t.bool, t.null], color: "#c2410c" },
...
const editorFont = "'M PLUS 1 Code', 'JetBrains Mono', 'UDEV Gothic 35', monospace"
